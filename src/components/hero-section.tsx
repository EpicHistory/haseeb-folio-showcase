    ...
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-5xl mt-20 sm:mt-12 sm:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent dark:from-gray-100 dark:via-blue-200 dark:to-purple-200 mb-6">
            Muhammad Haseeb
          </h1>
