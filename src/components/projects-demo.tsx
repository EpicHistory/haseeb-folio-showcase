...
export default function ProjectsDemo() {
  ...
  return (
    <div className="py-2 bg-white dark:bg-black" id="projects">
      <div className="text-center mb-3">
        <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-1">
          Featured Projects
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-w-7xl mx-auto px-4">
